...
print(data)
init = pd.read_csv("./data/result/knn_traindata_6.csv")
init = np.unique(init.values.reshape([1,-1]))
print(init)
print(len(init))
...
ax[0].set_xlim(0, 5)
ax[0].set_ylim(0, 5)
plt.savefig("./data/FAVAL_ARAnet_test_{}_{}_fold.png".format("matbench_dielectric", k))
plt.show()